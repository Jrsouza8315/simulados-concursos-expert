...
const HeroSection = () => {
  return (
    <section id="inicio" className="relative pt-20 pb-16 overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-16 h-16 bg-secondary-100 rounded-full animate-float opacity-60" style={{animationDelay: '2s'}}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Plataforma completa com simulados personalizados, apostilas atualizadas e acompanhamento detalhado do seu progresso.
            </p>

            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-secondary-500" />
                <span className="text-gray-700">Mais de 50.000 questões atualizadas</span>
              </div>
              <div className="flex items-center gap-3">
                <Clock className="h-5 w-5 text-secondary-500" />
                <span className="text-gray-700">Simulados cronometrados e personalizados</span>
              </div>
              <div className="flex items-center gap-3">
                <Calendar className="h-5 w-5 text-secondary-500" />
                <span className="text-gray-700">Concursos sempre atualizados</span>
              </div>
            </div>
